...
/**
 * Creates a bogus {@link SSLContext}. A client-side context created by this factory accepts any certificate even if it is invalid. A server-side context created by this factory sends a bogus
 * certificate defined in {@link SslKeyStore}.
 * <p>
 ...
 * {@link SSLContext#init(KeyManager[], TrustManager[], java.security.SecureRandom)}.</li>
 ...
 * {@link SSLContext#init(KeyManager[], TrustManager[], java.security.SecureRandom)} to validate the client certificate.</li>
 * </ul>
 * 
